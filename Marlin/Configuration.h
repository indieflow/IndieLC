...
#define DISABLE_Z true  // Allows for fine adjustment of first layer
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {106.67,106.67,8000,1457.29}  // default steps per unit for ultimaker 
